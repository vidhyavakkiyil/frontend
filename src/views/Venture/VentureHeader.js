import { BusyIndicator, Button, CheckBox, FlexBox, Icon, Label, Option, ResponsiveGridLayout, Select, TabSeparator, Toolbar, ToolbarSpacer } from '@ui5/webcomponents-react'
import React from 'react'

function VentureHeader(props) {
    return (
        <div >
            ...
            <FlexBox {...props}>
                ...
                <Button   style={{ marginRight:"10px"}} design="Transparent">Hide/Show Info Toolbar</Button>
            <FlexBox >
